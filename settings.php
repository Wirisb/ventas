                    ...
                    <button type="submit" class="btn btn-success pull-left" name="form2">Actualizar Favicon</button>
                        ...
                        <div class="tab-pane" id="tab_3">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Pie de página - Copyright </label>
                                        <div class="col-sm-9">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Contacto Correo electrónico </label>
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" name="contact_email" value="<?php echo $contact_email; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Número de Teléfono de Contacto </label>
                                        <div class="col-sm-6">
                                 ...
                                 <!-- <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-2 control-label">Mapa de Contacto iFrame </label>
                                        <div class="col-sm-9">
                        ...
                        <div class="tab-pane" id="tab_4">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Contacto Dirección de correo electrónico</label>
                                        <div class="col-sm-4">
                                            <input type="text" class="form-control" name="receive_email" value="<?php echo $receive_email; ?>">
                                        </div>
                                    </div>                                  
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Contacto Correo electrónico Asunto</label>
                                        <div class="col-sm-8">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Olvidar contraseña Mensaje</label>
                                        <div class="col-sm-8">
                        ...
                        <div class="tab-pane" id="tab_5">
                            ...
                            <div class="box box-info">
                                <div class="box-body">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Página de inicio (Cuántos últimos productos?)<span>*</span></label>
                                        <div class="col-sm-2">
                                            <input type="text" class="form-control" name="total_latest_product_home" value="<?php echo $total_latest_product_home; ?>">
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <label for="" class="col-sm-4 control-label">Página de inicio (Cuántos productos populares?)<span>*</span></label>
                                        <div class="col-sm-2">
                        ...
                        <div class="tab-pane" id="tab_6">
                        	...
                        	<h3>Secciones Encendido y apagado</h3>
                            <form class="form-horizontal" action="" method="post">
                            <div class="box box-info">
                                <div class="box-body">
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Sección de Servicios </label>
                                        <div class="col-sm-4">
                                    ...
                                    <div class="form-group">
                                        <label for="" class="col-sm-3 control-label">Última Sección de Productos </label>
                                        <div class="col-sm-4">
                ...
                <div class="col-sm-6">
                    <button type="submit" class="btn btn-success pull-left" name="form6">Actualizar</button>
                           ...
                           <!-- <h3>Call to Action Section</h3>
                            ...
                            <h3>Sección de Producto Destacado</h3>
<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <div class="box box-info">
        <div class="box-body">                                          
            <div class="form-group">
...
<h3>Sección de Producto Más Reciente</h3>
<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <div class="box box-info">
        <div class="box-body">                                          
            <div class="form-group">
                <label for="" class="col-sm-3 control-label">Título del Producto Más Reciente <span>*</span></label>
                <div class="col-sm-8">
                    <input type="text" class="form-control" name="latest_product_title" value="<?php echo $latest_product_title; ?>">
                </div>
            </div>
            <div class="form-group">
                <label for="" class="col-sm-3 control-label">Subtítulo del Producto Más Reciente <span>*</span></label>
                <div class="col-sm-8">
...
<h3>Sección de Producto Popular</h3>
<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <div class="box box-info">
        <div class="box-body">                                          
            <div class="form-group">
            ...
            <div class="form-group">
                <label for="" class="col-sm-3 control-label">Subtítulo del Producto Popular <span>*</span></label>
                <div class="col-sm-8">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <button type="submit" class="btn btn-success pull-left" name="form6_6">Actualizar</button>
                            ...
                            <h3>Sección del Boletín Informativo</h3>
<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
    <div class="box box-info">
        <div class="box-body">                                          
            <div class="form-group">
    ...
    <table class="table table-bordered">
        <tr>
            <form action="" method="post" enctype="multipart/form-data">
                <td style="width:50%">
                    <h4>Banner Actual de Página de Inicio de Sesión</h4>
                    <p>
        ...
        <tr>
            <form action="" method="post" enctype="multipart/form-data">
                <td style="width:50%">
                    <h4>Banner Actual de Página de Registro</h4>
                    <p>
        ...
        <tr>
            <form action="" method="post" enctype="multipart/form-data">
                <td style="width:50%">
                    <h4>Banner Actual de Página de Recuperar Contraseña</h4>
                    <p>
                        <img src="<?php echo '../assets/uploads/'.$banner_forget_password; ?>" alt="" style="width: 100%;height:auto;">   
                    </p>                                        
                </td>
                <td style="width:50%">
                    <h4>Cambiar Banner de Página de Recuperar Contraseña</h4>
                    Seleccionar Foto<input type="file" name="photo">
        ...
        <tr>
            <form action="" method="post" enctype="multipart/form-data">
                <td style="width:50%">
                    <h4>Banner Actual de Página de Restablecer Contraseña</h4>
                    <p>
                        <img src="<?php echo '../assets/uploads/'.$banner_reset_password; ?>" alt="" style="width: 100%;height:auto;">   
                    </p>                                        
                </td>
                <td style="width:50%">
                    <h4>Cambiar Banner de Página de Restablecer Contraseña</h4>
                    Seleccionar Foto<input type="file" name="photo">
        ...
        <tr>
            <form action="" method="post" enctype="multipart/form-data">
                <td style="width:50%">
                    <h4>Banner Actual de Página de Búsqueda</h4>
                    <p>
                        <img src="<?php echo '../assets/uploads/'.$banner_search; ?>" alt="" style="width: 100%;height:auto;">  
                    </p>                                        
                </td>
                <td style="width:50%">
                    <h4>Cambiar Banner de Página de Búsqueda</h4>
                    Seleccionar Foto<input type="file" name="photo">
        ...
        <tr>
            <form action="" method="post" enctype="multipart/form-data">
                <td style="width:50%">
                    <h4>Banner Actual de Página del Carrito</h4>
                    <p>
                        <img src="<?php echo '../assets/uploads/'.$banner_cart; ?>" alt="" style="width: 100%;height:auto;">  
                    </p>                                        
                </td>
                <td style="width:50%">
                    <h4>Cambiar Banner de Página del Carrito</h4>
                    Seleccionar Foto<input type="file" name="photo">
        ...
        <tr>
            <form action="" method="post" enctype="multipart/form-data">
                <td style="width:50%">
                    <h4>Banner Actual de Página de Pago</h4>
                    <p>
        ...
        <tr>
            <form action="" method="post" enctype="multipart/form-data">
                <td style="width:50%">
                    <h4>Banner Actual de Página de Categoría de Productos</h4>
                    <p>
                        <img src="<?php echo '../assets/uploads/'.$banner_product_category; ?>" alt="" style="width: 100%;height:auto;">  
                    </p>                                        
                </td>
                <td style="width:50%">
                    <h4>Cambiar Banner de Página de Categoría de Productos</h4>
                    Seleccionar Foto<input type="file" name="photo">
        ...
        <tr>
            <form action="" method="post" enctype="multipart/form-data">
                <td style="width:50%">
                    <h4>Banner Actual de Página del Blog</h4>
                    <p>
                        <img src="<?php echo '../assets/uploads/'.$banner_blog; ?>" alt="" style="width: 100%;height:auto;">  
                    </p>                                        
                </td>
                <td style="width:50%">
                    <h4>Cambiar Banner de Página del Blog</h4>
                    Seleccionar Foto<input type="file" name="photo">
                    <input type="submit" class="btn btn-primary btn-xs" value="Cambiar" style="margin-top:10px;" name="form7_10">
                </td>
            </form>
        </tr>
        -->
...
<div class="tab-pane" id="tab_9">
    <form class="form-horizontal" action="" method="post">
        <div class="box box-info">
            <div class="box-body">
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">PayPal - Correo Electrónico de Empresa</label>
                    <div class="col-sm-5">
                ...
                <!--
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Stripe - Clave Pública</label>
                    <div class="col-sm-5">
                        <input type="text" name="stripe_public_key" class="form-control" value="<?php echo $stripe_public_key; ?>">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-2 control-label">Stripe - Clave Secreta</label>
                    <div class="col-sm-5">
                        ...
                        <div class="tab-pane" id="tab_10">
                            <form class="form-horizontal" action="" method="post">
                                <div class="box box-info">
                                    <div class="box-body">
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Codigo antes &lt;/head&gt; etiqueta </label>
                                            <div class="col-sm-8">
                                                <textarea name="before_head" class="form-control" cols="30" rows="10"><?php echo $before_head; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Codigo despues &lt;body&gt; etiqueta </label>
                                            <div class="col-sm-8">
                                                <textarea name="after_body" class="form-control" cols="30" rows="10"><?php echo $after_body; ?></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="" class="col-sm-2 control-label">Codigo antes &lt;/body&gt; etiqueta</label>
                                            <div class="col-sm-8">
