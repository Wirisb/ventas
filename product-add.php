...
if(isset($_POST['form1'])) {
    ...
    if(empty($_POST['tcat_id'])) {
        $valid = 0;
        $error_message .= "Debe seleccionar una categoría principal<br>";
    }

    if(empty($_POST['mcat_id'])) {
        $valid = 0;
        $error_message .= "Debe seleccionar una categoría intermedia<br>";
    }

    if(empty($_POST['ecat_id'])) {
        $valid = 0;
        $error_message .= "Debe seleccionar una categoría final<br>";
    }
    ...
    if($path!='') {
        ...
        if($ext!='jpg' && $ext!='png' && $ext!='jpeg' && $ext!='gif') {
            $valid = 0;
            $error_message .= 'Debe subir un archivo en formato jpg, jpeg, gif o png<br>';
        }
    } else {
    	$valid = 0;
        $error_message .= 'Debe seleccionar una foto destacada<br>';
    }
    ...
    if($valid == 1) {
		...
		//Guardando datos en la tabla principal tbl_product
    	...
    	$success_message = 'El producto se ha agregado exitosamente.';
    }
}
?>
			...
			<form class="form-horizontal" action="" method="post" enctype="multipart/form-data">
				...
				<div class="box box-info">
					<div class="box-body">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Nombre de Categoría Final <span>*</span></label>
							<div class="col-sm-4">
								<select name="ecat_id" class="form-control select2 end-cat">
									<option value="">Seleccionar Categoría Final</option>
								</select>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Seleccionar Talla</label>
							<div class="col-sm-4">
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Foto Principal <span>*</span></label>
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
			                    <input type="button" id="btnAddNew" value="Agregar Elemento" style="margin-top: 5px;margin-bottom:10px;border:0;color: #fff;font-size: 14px;border-radius:3px;" class="btn btn-warning btn-xs">
			                </div>
						</div>
						<div class="form-group">
