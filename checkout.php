    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
	                            ...
	                            <div class="row">
	                                ...
	                                <div class="col-md-12 form-group">
	                                    ...
	                                    <select name="payment_method" class="form-control select2" id="advFieldsStatus">
                                            ...
                                            <option value="Efectivo"><?php echo LANG_VALUE_164; ?></option>
	                                    </select>
	                                </div>
                ...
                <?php $_SESSION['final_total'] = $final_total; ?>
<form action="payment/efectivo/init.php" method="post" id="efectivo_form">
    <input type="hidden" name="amount" value="<?php echo $final_total; ?>">
    <div class="col-md-12 form-group">
        <input type="submit" class="btn btn-primary" value="<?php echo LANG_VALUE_46; ?>" name="form4">
    </div>
</form>
