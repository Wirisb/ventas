...
<section class="content">
    ...
    <label for="" class="col-sm-3 control-label">Nombre de Categoría Principal <span>*</span></label>
    <div class="col-sm-4">
        <select name="tcat_id" class="form-control select2 top-cat">
            <option value="">Seleccionar Categoría Principal</option>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Foto Principal Existente</label>
						...
						<div class="form-group">
							<label for="" class="col-sm-3 control-label">Cambiar Foto Principal </label>
							<div class="col-sm-4" style="padding-top:4px;">
